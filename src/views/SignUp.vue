<template>
  <div class="login-page">
    <Header/>
    <div class="card-container flex flex-col min-h-screen-90 justify-center m-auto w-2/5 relative">
      <div class="circle">
      </div>
      <div class="card flex flex-col items-center min-h-20 ">
        ...
        <div class="inputs w-2/4 mb-10 mt-10"  >
          ...
          <user-input place-holder="Username" input-name="username"></user-input>
          <user-input place-holder="Email@email.com" input-name="email"></user-input>
          <user-input place-holder="Password" input-name="password" ></user-input>
...
<style scoped>
.card {
  background: linear-gradient(135deg, rgba(44, 62, 80, 0.5), rgba(44, 62, 80, 0.5));
